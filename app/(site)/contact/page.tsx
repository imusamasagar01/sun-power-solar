              ...
              <div className="mt-4 flex gap-2.5">
                {socials.map(({ href, label, Icon }) => (
                  <a
                    ...
                    rel="noreferrer"
                    aria-label={label}
                    className="flex h-10 w-10 items-center justify-center rounded-xl border border-ink-100 text-ink-500 transition-all duration-300 hover:border-brand-600 hover:bg-brand-600 hover:text-white"
                  >
...
function ContactCard({
  ...
  const content = (
    <>
      <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-600/10 text-brand-700 transition-colors duration-300 group-hover:bg-brand-600 group-hover:text-white">
  ...
  const className =
    "group flex items-start gap-4 rounded-2xl border border-ink-100 bg-white p-5 transition-all duration-300 hover:border-brand-200 hover:shadow-card";
